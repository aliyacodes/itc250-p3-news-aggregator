...
if(isset($_GET['catid']) && isset($_GET['feedid']) && (int)$_GET['catid'] > 0 && (int)$_GET['feedid'] > 0){#proper data must be on querystring
...
$sql = 
    ...
    where f.FeedID=" . $feedID . " order by f.FeedID";
...
{#there are records - present data
	...
	{# pull data from associative array
	   echo '<p>';
	   echo 'Feed Name: <b>' . $row['FeedName'] . '</b><br />';
      ...
      {
          echo '<p>';
          echo 'Article Title: ' . '<a href="' . $story->link . '">' . $story->title . '</a><br />';
          echo '</p>';
